...
importers:
  ...
  .:
    ...
    devDependencies:
      ...
      eslint: 8.22.0
      eslint-config-alloy: 4.6.2_caurnrczp7k4s2jev6tz4fmjji
  ...
  packages/react:
    ...
    dependencies:
      slate: 0.82.1
      slate-history: 0.66.0_slate@0.82.1
      slate-react: 0.82.2_slate@0.82.1
...
packages:
  ...
  /eslint-config-alloy/4.6.2_caurnrczp7k4s2jev6tz4fmjji:
    resolution: {integrity: sha512-mntO/1jazNIJJCb3mwtaH4D9uLnEIzI0EM2aYnllYVBmET0t490yBSLdPz+5cWtJsHU2DkW7aPI/kFtal9Vopg==}
    peerDependencies:
  ...
  /slate-react/0.82.2_slate@0.82.1:
    resolution: {integrity: sha512-lNmSqqNOKQJG1i3Wx4MkggWr6dLhQ43n4exPf5NLmKVBHPBuQSRNaWhAAKm6HOEC36Q6xBfkVONIQWi3GSyIEQ==}
    peerDependencies:
      react: '>=16.8.0'
      react-dom: '>=16.8.0'
      slate: '>=0.65.3'
